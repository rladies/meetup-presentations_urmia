Title: "Visualization_R4DS"
Author: "Nasrin Attar- Rladies Urmia"
date: "2021.11.25"
chapter: R4DS-data-visualization

The online version of book
```{r}
browseURL("https://r4ds.had.co.nz/index.html")
```  



```{r}
browseURL("https://jrnold.github.io/r4ds-exercise-solutions/data-visualisation.html#geometric-objects")
```  

Git hub Hadley
```{r}
browseURL("https://github.com/hadley/r4ds")
```  

The recommendation of Hadley
```{r}
browseURL("https://vita.had.co.nz/papers/layered-grammar.html")
```  


#ggplot2 great introduction
```{r}
browseURL("https://bookdown.org/agrogankaylor/quick-intro-to-ggplot2/quick-intro-to-ggplot2.html")
```  
...
A guide for ggplot understanding
```{r}
browseURL("https://evamaerey.github.io/ggplot_flipbook/ggplot_flipbook_xaringan.html#1")
```  

A great book for ggplot2
```{r}
browseURL("https://ggplot2-book.org/index.html")
```  
...
installing packages ggplot2 and tidyverse  
  ## Introduction 
```{r}
library(tidyverse)
```  
...
In the chapter, the legend is suppressed because with three plots, adding a legend to only the last plot would make the sizes of plots different.
...
```{r}
browseURL("https://ggplot2.tidyverse.org/reference/stat_summary.html")
```  
...
```{r}
browseURL("https://ggplot2.tidyverse.org/reference/geom_linerange.html")
```  
...
The following tables contain the geoms and stats in [ggplot2] and their defaults as of version 3.3.0.
...
```{r}
browseURL("https://ggplot2.tidyverse.org/reference/geom_jitter.html")
```
...
See the documentation for [`position_dodge2()`] for additional discussion on how it works.
...
By default, `coord_map()` uses the [Mercator projection]
```{r}
browseURL("https://en.wikipedia.org/wiki/Mercator_projection")
```
...
```{r}
browseURL("https://ggplot2.tidyverse.org/reference/coord_map.html")
```
